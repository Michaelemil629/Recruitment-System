            ...
            <div class="flex container">
                ...
                <nav>
                    ...
                    <ul id="nav-menu">
                        ...
                        <button style = "background-color: #0e76a8; border-radius: 8px; font-size: 17px; padding: 5px 12px;"><a href="ViewProfile.php?id=<?php echo $_SESSION["id"];?>" style="color: floralwhite ; text-decoration: none;"> My Profile </a></button> 
