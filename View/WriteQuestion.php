...
<header>
            <div class="flex container">
                <a id="logo" href="#"> Write question </a>
                <nav>
                    ...
                    <ul id="nav-menu"> 
                        ...
                        <li><a href="Candidate.php"><img src="images/Linkedin_icon.svg.png" alt="Logo" style="width:80px;height:80px;  position:fixed; left:80px; top:7px;"></a></li>
                        ...
                        <button style = "background-color: #0e76a8; border-radius: 8px; font-size: 17px; padding: 5px 12px;"><a href="MyCart.php?id=<?php echo $_SESSION["id"];?>" style="color: floralwhite ; text-decoration: none;" > My Cart </a></button>
...
<body>
  ...
  <section id="hero">
      ...
      <div class="hero-text">
          ...
          <!-- F el noss -->
<h1>your questions will sent to the recrutier and give well answer</h1>
