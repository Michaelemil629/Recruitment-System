            ...
            <div class="flex container">
                ...
                <nav>
                    ...
                    <ul id="nav-menu"> 
                        ...
                        <button style = "background-color: #0e76a8; border-radius: 8px; font-size: 17px; padding: 5px 12px;"><a href="AuditorComment.php" style = "text-decoration: none; color: floralwhite;"> See Comminication and add comment </a></button>
...
<body>
  ...
  <section id="hero">
      ...
      <div class="hero-text">
          ...
          <!-- F el noss -->
          <h2 style = " color: white;"> Welcome Vteam <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b> to linkdn RS.</h2>
       </div>
      </section>
  </div>
